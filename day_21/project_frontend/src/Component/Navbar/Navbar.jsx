...
import logo_dark from "../../assets/akatsuki.png"
        ...
        <div className="profile_container">
          <div className="profile_box">
            <div className='img_package'>
              ...
              <div className="editbutton"><BiMessageSquareEdit onClick={() => { setShowImagein(!showimagein); setShowSavepic(!showsavepic) }} /></div>

            </div>
            <div className="profile_detail">
              <div className="profile_name">Hi,{userr ? userr?.username : "Guest"} </div>
              <div className="profile_email">{userr ? userr?.email : ""} </div>
              {userr ?
                <button onClick={logoutprofile} className="logout">LOGOUT</button>:
                <button onClick={loginprofile} className="logout">LOGIN</button>
              }
              <button onClick={logoutprofile} className="my_uploads">MY UPLOADS</button>
            </div>
          </div>
        </div>
      }
