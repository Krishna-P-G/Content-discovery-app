...
import error_msg from "../assets/error-message.png";
...
function Login() {
  ...
  const handleSignIn = async (e) => {
    if (nameValue === "" || passwordValue === "") {
      ...
      e.preventDefault();
      const res = await userLogin(nameValue, passwordValue).then((res) => {
        console.log(res.data);
      ...
      <div className="boop">
        <div className="container" id="container">
          ...
          <div className="form-container sign-up-container">
            ...
            >
              <h1 className="create_account">Create Your Cloud Account</h1>

              <span className="signup-name-out">Name</span>
              <input
                type="text"
                placeholder="Name"
                value={nameValue}
              ...
              <span className="signup-email-out">Email</span>
              <input
                type="email"
                placeholder="Email"
                value={emailValue}
              ...
              <span className="signup-password-out">Password</span>
              <input
              ...
              <input
                type="checkbox"
                className="checkbox"
                checked={isCheckboxChecked} // Bind the checkbox to the state variable
                onChange={(e) => setIsCheckboxChecked(e.target.checked)} // Step 2
              />
          ...
          <div className="form-container sign-in-container">
            <form
              ...
              onSubmit={(e) => e.preventDefault()}
            >
              <h1 className="signIn-account">Sign into your Cloud Account</h1>
            ...
            <span className="login_name_out">Name</span>
              <input
                type="text"
                ...
                required
              />
              <span className="error-message-4">{nameError}</span>
              <span className="login_password_out">Password</span>
              <input
                type={isPasswordVisible ? "text" : "password"}
                placeholder="Password"
                value={passwordValue}
